    ...
    render() {
        return (
            <div className="ui grid">
                ...
                <FilterCard link="/list" labelText="Prototype" imgSrc="../img/classes/prototype.jpg" onClick={() => this.props.selectClass('Prototype')} />
                <FilterCard link="/list" labelText="Open Wheel" imgSrc="../img/classes/openWheeler.jpg" onClick={() => this.props.selectClass('Open Wheel')} />
            </div>
        );
    }
}
