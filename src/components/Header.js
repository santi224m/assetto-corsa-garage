            ...
            <div className='ui container'>
                ...
                <div className='right menu'>
                    ...
                    >
                        ...
                        <div className={`menu transition ${dropDownClicked ? 'visible' : ''}`}>
                            <Link className='item' to='/filters/brands'>
                                Brands
                            </Link>
                            <Link className='item' to='/filters/class'>
                                Class
                            </Link>
                            <Link className='item' to='/filters/decades'>
                                Decades
                            </Link>
                            <Link className='item' to='/filters/shifters'>
                                Shifters
                            </Link>
                        </div>
                    </div>
                ...
                <div className='sidebar'>
                    ...
                    <div className='sidebar-links'>
                        ...
                        <Link onClick={() => toggleSidebar()} className='item' to='/'>
                            Home
                        </Link>
                        <Link onClick={() => toggleSidebar()} className='item' to='/list'>
                            All Cars
                        </Link>
                        <div className='ui header'>Filters</div>
                        <Link onClick={() => toggleSidebar()} className='item' to='/filters/brands'>
                            Brands
                        </Link>
                        <Link onClick={() => toggleSidebar()} className='item' to='/filters/class'>
                            Class
                        </Link>
                        <Link onClick={() => toggleSidebar()} className='item' to='/filters/decades'>
                            Decades
                        </Link>
                        <Link onClick={() => toggleSidebar()} className='item' to='/filters/shifters'>
                            Shifters
                        </Link>
                    </div>
                </div>
