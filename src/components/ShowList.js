...
class ShowList extends React.Component {
    ...
    renderCars() {
        this.filteredCarsArr = this.props.cars
            .filter(car => {
                ...
                const decadeIsSelected =
                    this.props.selectedFilters.selectedDecade &&
                    !(
                        this.props.selectedFilters.selectedDecade + 10 - car.year < 10 &&
                        this.props.selectedFilters.selectedDecade + 10 - car.year > 0
                    );
                const shifterIsSelected =
                    this.props.selectedFilters.selectedShifter && this.props.selectedFilters.selectedShifter !== car.transmission;
                ...
                const searchTermFilter =
                    this.props.selectedFilters.searchTerm && !carSearchTerm.includes(this.props.selectedFilters.searchTerm.toLowerCase());
        ...
        return this.filteredCarsArr.map(car => {
            ...
            if (
                this.filteredCarsArr &&
                (this.filteredCarsArr.indexOf(car) < paginationStartIndex || this.filteredCarsArr.indexOf(car) > paginationEndIndex)
            ) {
                return;
            }
            ...
            return (
                <div className='ui card' key={car.id}>
                    ...
                    <div className='content'>
                        <a href={car.link} className='header center aligned' target='_blank'>
                            {car.brand}
                        </a>
                    ...
                    <div className='extra content'>
                        <a href={carWikiURL} target='_blank' className='ui basic black button fluid'>
                            Learn More
                        </a>
                        <br />
                        <a href={car.link} className='ui button fluid green' target='_blank'>
                            Go to Mod
                        </a>
                    </div>
                </div>
